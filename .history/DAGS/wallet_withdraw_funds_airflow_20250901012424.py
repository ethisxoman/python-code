...
w.bank AS withdraw_funds_bank_id, 
    w.payment_type AS withdraw_funds_payment_type,
case 
    when w.payment_type = 1 then "Bank" 
    when w.payment_type = 2 then "Credit/Debit" 
    else null 
end AS withdraw_funds_payment_label,
...
def extract_and_load_func(**dictionary):
    ...
    -- Wallet: Withdraw Funds
        ...
        withdraw_funds_payment_label VARCHAR(50),
