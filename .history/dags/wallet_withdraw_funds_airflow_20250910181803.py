...
def extract_and_load_func(**dictionary):
    ...
    UNIQUE KEY uniq_user_withdraw (withdraw_funds_bank_id)
);
    """
...
with DAG(
    ...
    )  /home/abdullah/Desktop/Ethisx_Reporting/ssquare/reporting_env/venv/dags/wallet_withdraw_funds_airflow.py